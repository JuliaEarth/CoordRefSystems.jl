...
"""
function rotation(::Type{T}, transform::GeocentricTransform) where {T}
...
Create a Geocentric Helmert transform from time-dependent parameters:
...
See also [`GeocentricHelmert`](@ref).
