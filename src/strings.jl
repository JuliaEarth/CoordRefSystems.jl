...
const esriid2code = let
  ...
  for zone in 1:60
    ...
    d["WGS_1984_UTM_Zone_$(zone)N"] = EPSG{NorthCode}
    d["WGS_1984_UTM_Zone_$(zone)S"] = EPSG{SouthCode}
  end

  for zone in 11:22
    NorthCode = 31954 + zone
    d["SIRGAS_2000_UTM_Zone_$(zone)N"] = EPSG{NorthCode}
  end

  for zone in 17:25
    SouthCode = 31960 + zone
    d["SIRGAS_2000_UTM_Zone_$(zone)S"] = EPSG{SouthCode}
  end
