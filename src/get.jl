...
get(::Type{EPSG{29901}}) = shift(TransverseMercator{1.0,53.5°,-8.0°,OSNI_1952}, xₒ=200000.0m, yₒ=250000.0m)
get(::Type{EPSG{29902}}) = shift(TransverseMercator{1.000035,53.5°,-8.0°,TM65}, xₒ=200000.0m, yₒ=250000.0m)
