...
@crscode EPSG{4617} LatLon{NAD83CSRS}
...
@crscode EPSG{8232} LatLon{NAD83CSRSv1}
@crscode EPSG{8237} LatLon{NAD83CSRSv2}
@crscode EPSG{8240} LatLon{NAD83CSRSv3}
@crscode EPSG{8246} LatLon{NAD83CSRSv4}
@crscode EPSG{8249} LatLon{NAD83CSRSv5}
@crscode EPSG{8252} LatLon{NAD83CSRSv6}
@crscode EPSG{8255} LatLon{NAD83CSRSv7}
@crscode EPSG{9988} Cartesian3D{ITRF{2020}}
@crscode EPSG{10176} Cartesian3D{IGS20}
@crscode EPSG{10414} LatLon{NAD83CSRSv8}
