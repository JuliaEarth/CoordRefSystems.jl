...
Base.isapprox(coords₁::GeodeticLatLon{Datum₁}, coords₂::GeodeticLatLon{Datum₂}; kwargs...) where {Datum₁,Datum₂} =
  isapprox(coords₁, convert(GeodeticLatLon{Datum₁}, coords₂); kwargs...)

Base.isapprox(coords₁::GeodeticLatLon{D}, coords₂::GeodeticLatLon{D}; kwargs...) where {D<:Datum} =
...
Base.isapprox(coords₁::GeodeticLatLonAlt{Datum₁}, coords₂::GeodeticLatLonAlt{Datum₂}; kwargs...) where {Datum₁,Datum₂} =
  isapprox(coords₁, convert(GeodeticLatLonAlt{Datum₁}, coords₂); kwargs...)

Base.isapprox(coords₁::GeodeticLatLonAlt{D}, coords₂::GeodeticLatLonAlt{D}; kwargs...) where {D<:Datum} =
  isapproxangle(coords₁.lat, coords₂.lat) && isapproxangle(coords₁.lon, coords₂.lon) && isapproxlength(coords₁.alt, coords₂.alt)
