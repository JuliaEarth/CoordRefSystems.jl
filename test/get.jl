@testset "get" begin
  ...
  gettest(EPSG{4617}, LatLon{NAD83CSRS})
  ...
  gettest(EPSG{8232}, LatLon{NAD83CSRSv1})
  gettest(EPSG{8237}, LatLon{NAD83CSRSv2})
  gettest(EPSG{8240}, LatLon{NAD83CSRSv3})
  gettest(EPSG{8246}, LatLon{NAD83CSRSv4})
  gettest(EPSG{8249}, LatLon{NAD83CSRSv5})
  gettest(EPSG{8252}, LatLon{NAD83CSRSv6})
  gettest(EPSG{8255}, LatLon{NAD83CSRSv7})
  gettest(EPSG{9988}, Cartesian{ITRF{2020},3})
  gettest(EPSG{10176}, Cartesian{IGS20,3})
  gettest(EPSG{10414}, LatLon{NAD83CSRSv8})
