@testset "Constructors" begin
  @testset "Basic" begin
    ...
    @test isapprox(Polar(T(1) * m, T(45) * °), Polar(T(1) * m, T(π / 4) * rad))
    ...
    @test isapprox(Cylindrical(T(1) * m, T(45) * °, T(1) * m), Cylindrical(T(1) * m, T(π / 4) * rad, T(1) * m))
    ...
    @test isapprox(Spherical(T(1) * m, T(45) * °, T(45) * °), Spherical(T(1) * m, T(π / 4) * rad, T(π / 4) * rad))
  ...
  @testset "Geographic" begin
    for C in geographic2D
      ...
      @test isapprox(C(T(π / 4) * rad, T(π / 4) * rad), C(T(45) * °, T(45) * °))
    ...
    for C in geographic3D
      ...
      @test isapprox(C(T(π / 4) * rad, T(π / 4) * rad, T(1) * km), C(T(45) * °, T(45) * °, T(1000) * m))
