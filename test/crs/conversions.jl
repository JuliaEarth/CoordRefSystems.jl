@testset "Conversions" begin
  @testset "Basic" begin
    @testset "Cartesian <> Polar" begin
      ...
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(√2), T(π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(1))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(√2), T(3π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), -T(1))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(√2), T(5π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), -T(1))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(√2), T(7π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), T(1))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(1), T(π / 2)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), -T(1))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(1), T(3π / 2)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), T(0))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(1), T(0)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(0))
      c2 = convert(Polar, c1)
      @test isapproxcoords(c2, Polar(T(1), T(π)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "Cartesian <> Cylindrical" begin
      ...
      @test isapproxcoords(c2, Cylindrical(T(√2), T(π / 4), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(1), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(√2), T(3π / 4), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), -T(1), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(√2), T(5π / 4), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), -T(1), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(√2), T(7π / 4), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), T(1), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(1), T(π / 2), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), -T(1), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(1), T(3π / 2), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), T(0), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(1), T(0), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(0), T(1))
      c2 = convert(Cylindrical, c1)
      @test isapproxcoords(c2, Cylindrical(T(1), T(π), T(1)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "Cartesian <> Spherical" begin
      ...
      @test isapproxcoords(c2, Spherical(T(√3), atan(T(√2)), T(π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(1), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√3), atan(T(√2)), T(3π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), -T(1), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√3), atan(T(√2)), T(5π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), -T(1), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√3), atan(T(√2)), T(7π / 4)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), T(1), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√2), T(π / 4), T(π / 2)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(0), -T(1), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√2), T(π / 4), T(3π / 2)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(T(1), T(0), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√2), T(π / 4), T(0)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)

      c1 = Cartesian(-T(1), T(0), T(1))
      c2 = convert(Spherical, c1)
      @test isapproxcoords(c2, Spherical(T(√2), T(π / 4), T(π)))
      c3 = convert(Cartesian, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "Cartesian: Datum conversion" begin
      ...
      @test isapproxcoords(c2, Cartesian{ITRF{2008}}(T(0), T(0), T(0)))

      c1 = Cartesian{WGS84{1762}}(T(1), T(1), T(1))
      c2 = convert(Cartesian{ITRF{2008}}, c1)
      @test isapproxcoords(c2, Cartesian{ITRF{2008}}(T(1), T(1), T(1)))

      # ITRF2008 to ITRF2020
      c1 = Cartesian{ITRF{2008}}(T(0), T(0), T(0))
      c2 = convert(Cartesian{ITRF{2020}}, c1)
      @test isapproxcoords(c2, Cartesian{ITRF{2020}}(T(-0.0002), T(-0.002), T(-0.0023)))

      c1 = Cartesian{ITRF{2008}}(T(1), T(1), T(1))
      c2 = convert(Cartesian{ITRF{2020}}, c1)
      @test isapproxcoords(c2, Cartesian{ITRF{2020}}(T(0.9998000005900001), T(0.99800000059), T(0.9977000005900001)))
  ...
  @testset "Geographic" begin
    @testset "LatLon <> GeocentricLatLon" begin
      ...
      @test isapproxcoords(c2, GeocentricLatLon(T(29.833635809829065), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(35), T(40))
      c2 = convert(GeocentricLatLon, c1)
      @test isapproxcoords(c2, GeocentricLatLon(T(34.819388702349606), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(40), T(40))
      c2 = convert(GeocentricLatLon, c1)
      @test isapproxcoords(c2, GeocentricLatLon(T(39.810610551928434), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> AuthalicLatLon" begin
      ...
      @test isapproxcoords(c2, AuthalicLatLon(T(29.888997034459567), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(35), T(40))
      c2 = convert(AuthalicLatLon, c1)
      @test isapproxcoords(c2, AuthalicLatLon(T(34.87951854973729), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(40), T(40))
      c2 = convert(AuthalicLatLon, c1)
      @test isapproxcoords(c2, AuthalicLatLon(T(39.87369373453432), T(40)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> LatLonAlt" begin
      ...
      @test isapproxcoords(c2, LatLonAlt(T(30), T(40), T(0)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLonAlt{ITRF{2008}}(T(30), T(40), T(2.613849937915802e-5)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1762}}(T(35), T(45))
      c2 = convert(LatLonAlt{ITRF{2008}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2008}}(T(35), T(45), T(3.440864384174347e-5)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLonAlt{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2020}}(T(34.99999999095351), T(44.99999998605742), T(-0.002657238394021988)))
      c3 = convert(LatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)
    end
  ...
  @testset "LatLonAlt <> GeocentricLatLonAlt" begin
    ...
    @test isapproxcoords(c2, GeocentricLatLonAlt(T(29.833635809829065), T(40), T(0)))
    c3 = convert(LatLonAlt, c2)
    @test isapproxcoords(c3, c1)
  ...
  @testset "LatLon <> Cartesian" begin
    ...
    @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(4234890.278665873), T(3553494.8709047823), T(3170373.735383637)))
    c3 = convert(LatLon, c2)
    @test isapproxcoords(c3, c1)

    c1 = LatLon(T(35), T(45))
    c2 = convert(Cartesian, c1)
    @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3698470.287205801), T(3698470.2872058), T(3637866.909378095)))
    c3 = convert(LatLon, c2)
    @test isapproxcoords(c3, c1)

    c1 = LatLon(T(40), T(50))
    c2 = convert(Cartesian, c1)
    @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3144971.82314589), T(3748031.468841677), T(4077985.572200376)))
    c3 = convert(LatLon, c2)
    @test isapproxcoords(c3, c1)
    ...
    @testset "LatLonAlt <> Cartesian" begin
      ...
      c2 = convert(Cartesian, c1)
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3698528.2100023343), T(3698528.2100023334), T(3637924.26702173)))
      c3 = convert(LatLonAlt, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLonAlt(T(40), T(50), T(200))
      c2 = convert(Cartesian, c1)
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3145070.3039211915), T(3748148.8336594435), T(4078114.1297223135)))
      c3 = convert(LatLonAlt, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "GeocentricLatLonAlt <> Cartesian" begin
      ...
      c2 = convert(Cartesian, c1)
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(4227784.905275363), T(3547532.754713428), T(3186385.300568595)))
      c3 = convert(GeocentricLatLonAlt, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLonAlt(T(35), T(45), T(100))
      c2 = convert(Cartesian, c1)
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3690364.254026674), T(3690364.2540266733), T(3654357.744678035)))
      c3 = convert(GeocentricLatLonAlt, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLonAlt(T(40), T(50), T(200))
      c2 = convert(Cartesian, c1)
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(3136354.020667129), T(3737761.1717773457), T(4094220.2645078264)))
      c3 = convert(GeocentricLatLonAlt, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLonAlt: Datum conversion" begin
      ...
      c2 = convert(LatLonAlt{ITRF{2008}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2008}}(T(30), T(40), T(1.0000261394307017)))
      c3 = convert(LatLonAlt{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLonAlt{WGS84{1762}}(T(35), T(45), T(1))
      c2 = convert(LatLonAlt{ITRF{2008}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2008}}(T(35), T(45), T(1.0000344086438417)))
      c3 = convert(LatLonAlt{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLonAlt{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2020}}(T(29.999999988422587), T(39.99999998545356), T(0.9975402476266026)))
      c3 = convert(LatLonAlt{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLonAlt{ITRF{2008}}(T(35), T(45), T(1))
      c2 = convert(LatLonAlt{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLonAlt{ITRF{2020}}(T(34.99999999095351), T(44.99999998605742), T(0.9973427625373006)))
      c3 = convert(LatLonAlt{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "GeocentricLatLonAlt: Datum conversion" begin
      ...
      @test isapproxcoords(c2, GeocentricLatLonAlt{ITRF{2008}}(T(30), T(40), T(1.0000264029949903)))
      c3 = convert(GeocentricLatLonAlt{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLonAlt{WGS84{1762}}(T(35), T(45), T(1))
      c2 = convert(GeocentricLatLonAlt{ITRF{2008}}, c1)
      @test isapproxcoords(c2, GeocentricLatLonAlt{ITRF{2008}}(T(35), T(45), T(1.0000347206369042)))
      c3 = convert(GeocentricLatLonAlt{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon: Datum conversion" begin
      ...
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30), T(40)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NAD83}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35), T(45)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{ITRF{2008}}(T(30), T(40)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1762}}(T(35), T(45))
      c2 = convert(LatLon{ITRF{2008}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2008}}(T(35), T(45)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{ITRF{2014}}(T(30), T(40)))
      c3 = convert(LatLon{WGS84{2139}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{2139}}(T(35), T(45))
      c2 = convert(LatLon{ITRF{2014}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2014}}(T(35), T(45)))
      c3 = convert(LatLon{WGS84{2139}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{ITRF{2020}}(T(30), T(40)))
      c3 = convert(LatLon{WGS84{2296}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{2296}}(T(35), T(45))
      c2 = convert(LatLon{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2020}}(T(35), T(45)))
      c3 = convert(LatLon{WGS84{2296}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.00153253176913), T(40.00179973969016)))
      c3 = convert(LatLon{Carthage}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{Carthage}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.001164857937006), T(45.00208363872234)))
      c3 = convert(LatLon{Carthage}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.002400431894902), T(40.00192535096667)))
      c3 = convert(LatLon{GGRS87}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{GGRS87}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.0022781947901), T(45.002127518092834)))
      c3 = convert(LatLon{GGRS87}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(4.999662038651082), T(-45.000357065414555)))
      c3 = convert(LatLon{SAD69}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{SAD69}(T(10), T(-40))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(9.999702676265935), T(-40.00032719063254)))
      c3 = convert(LatLon{SAD69}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{SIRGAS2000}(T(4.99969445550929), T(-45.00040469598622)))
      c3 = convert(LatLon{SAD69}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{SAD69}(T(-10), T(-40))
      c2 = convert(LatLon{SIRGAS2000}, c1)
      @test isapproxcoords(c2, LatLon{SIRGAS2000}(T(-10.00042337668094), T(-40.00036774834545)))
      c3 = convert(LatLon{SAD69}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.002491990948382), T(39.99756285140804)))
      c3 = convert(LatLon{Hermannskogel}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{Hermannskogel}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.00226854367654), T(44.996794271771755)))
      c3 = convert(LatLon{Hermannskogel}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.003595375684984), T(39.99572206332302)))
      c3 = convert(LatLon{Ire65}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{Ire65}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.003385379949535), T(44.99524677680064)))
      c3 = convert(LatLon{Ire65}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.000667173416794), T(39.99980114703305)))
      c3 = convert(LatLon{NZGD1949}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NZGD1949}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.00052502406383), T(44.999734233826786)))
      c3 = convert(LatLon{NZGD1949}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.000000001862645), T(40.00000000023283)))
      c3 = convert(LatLon{NZGD2000}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NZGD2000}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.000000001862645), T(45.000000001396984)))
      c3 = convert(LatLon{NZGD2000}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.003642624158758), T(39.996222132850185)))
      c3 = convert(LatLon{OSGB36}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{OSGB36}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.003474099905354), T(44.99575175081459)))
      c3 = convert(LatLon{OSGB36}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.001530921141082), T(39.99588940866917)))
      c3 = convert(LatLon{Potsdam}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{Potsdam}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.00122407077783), T(44.995222349198244)))
      c3 = convert(LatLon{Potsdam}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{730}}(T(29.99999721267756), T(40.00000478084946)))
      c3 = convert(LatLon{WGS84{0}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{0}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{730}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{730}}(T(34.99999640829469), T(45.00000499945162)))
      c3 = convert(LatLon{WGS84{0}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{873}}(T(30.000000224982575), T(40.00000000620856)))
      c3 = convert(LatLon{WGS84{730}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{730}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{873}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{873}}(T(35.000000235106576), T(45.0000000309835)))
      c3 = convert(LatLon{WGS84{730}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(30.00000016323448), T(40.000000079668816)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1150}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(35.00000015214448), T(45.000000085204626)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(29.99999993150578), T(39.99999995021196)))
      c3 = convert(LatLon{WGS84{1674}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1674}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(34.999999928128716), T(44.99999994866557)))
      c3 = convert(LatLon{WGS84{1674}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{2139}}(T(30.00000004814441), T(39.9999998910735)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1762}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2139}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2139}}(T(35.00000004680104), T(44.999999888560545)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(29.99999995516499), T(40.00000001716362)))
      c3 = convert(LatLon{WGS84{2139}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{2139}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.99999995228484), T(45.0000000107594)))
      c3 = convert(LatLon{WGS84{2139}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{ITRF{2008}}(T(30), T(40))
      c2 = convert(LatLon{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2020}}(T(29.999999988422587), T(39.99999998545356)))
      c3 = convert(LatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{ITRF{2008}}(T(35), T(45))
      c2 = convert(LatLon{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2020}}(T(34.99999999095351), T(44.99999998605742)))
      c3 = convert(LatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{1150}}(T(30.00000010786122), T(39.999999917247415)))
      c3 = convert(LatLon{WGS84{873}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{873}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1150}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1150}}(T(35.00000011017596), T(44.99999991789371)))
      c3 = convert(LatLon{WGS84{873}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, LatLon{WGS84{1674}}(T(30.00000023172869), T(40.00000012945685)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1150}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{1674}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1674}}(T(35.000000224015764), T(45.00000013653905)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{ITRF{2008}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(30.000000002491856), T(39.99999990823712)))
      c3 = convert(LatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{ITRF{2008}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.99999999819903), T(44.99999989931995)))
      c3 = convert(LatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(29.999999954347434), T(40.00000001716363)))
      c3 = convert(LatLon{ITRF{2014}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{ITRF{2014}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.99999995139799), T(45.0000000107594)))
      c3 = convert(LatLon{ITRF{2014}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{0}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(29.999997712065273), T(40.00000469221133)))
      c3 = convert(LatLon{WGS84{0}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{0}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.9999969048076), T(45.000004932853365)))
      c3 = convert(LatLon{WGS84{0}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{730}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(30.000000499387685), T(39.999999911361925)))
      c3 = convert(LatLon{WGS84{730}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{730}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(35.000000496512904), T(44.9999999334018)))
      c3 = convert(LatLon{WGS84{730}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{873}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(30.000000274405107), T(39.99999990515338)))
      c3 = convert(LatLon{WGS84{873}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{873}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(35.00000026140633), T(44.9999999024183)))
      c3 = convert(LatLon{WGS84{873}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{1150}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(30.000000166543877), T(39.999999987905944)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1150}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(35.00000015123037), T(44.999999984524585)))
      c3 = convert(LatLon{WGS84{1150}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{1674}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(29.999999934815197), T(39.999999858449094)))
      c3 = convert(LatLon{WGS84{1674}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1674}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.9999999272146), T(44.99999984798553)))
      c3 = convert(LatLon{WGS84{1674}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon{WGS84{1762}}(T(30), T(40))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(30.000000003309403), T(39.99999990823712)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{WGS84{1762}}(T(35), T(45))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(34.99999999908588), T(44.99999989931995)))
      c3 = convert(LatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "GeocentricLatLon: Datum conversion" begin
      ...
      @test isapproxcoords(c2, GeocentricLatLon{ITRF{2008}}(T(30), T(40)))
      c3 = convert(GeocentricLatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLon{WGS84{1762}}(T(35), T(45))
      c2 = convert(GeocentricLatLon{ITRF{2008}}, c1)
      @test isapproxcoords(c2, GeocentricLatLon{ITRF{2008}}(T(35), T(45)))
      c3 = convert(GeocentricLatLon{WGS84{1762}}, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, GeocentricLatLon{ITRF{2020}}(T(29.999999988624147), T(39.99999998542911)))
      c3 = convert(GeocentricLatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLon{ITRF{2008}}(T(35), T(45))
      c2 = convert(GeocentricLatLon{ITRF{2020}}, c1)
      @test isapproxcoords(c2, GeocentricLatLon{ITRF{2020}}(T(34.999999991156464), T(44.99999998602658)))
      c3 = convert(GeocentricLatLon{ITRF{2008}}, c2)
      @test isapproxcoords(c3, c1)
  ...
  @testset "Projected" begin
    @testset "LatLon <> Mercator" begin
      ...
      @test isapproxcoords(c2, Mercator(T(10018754.171394622), T(5591295.9185533915)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> WebMercator" begin
      ...
      @test isapproxcoords(c2, WebMercator(T(10018754.171394622), T(5621521.486192066)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> PlateCarree" begin
      ...
      @test isapproxcoords(c2, PlateCarree(T(10018754.171394622), T(5009377.085697311)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Lambert" begin
      ...
      @test isapproxcoords(c2, Lambert(T(10018754.171394622), T(4489858.8869480025)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Behrmann" begin
      ...
      @test isapproxcoords(c2, Behrmann(T(8683765.222580686), T(5180102.328839251)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> GallPeters" begin
      ...
      @test isapproxcoords(c2, GallPeters(T(7096215.158458031), T(6338983.732612475)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> WinkelTripel" begin
      ...
      @test isapproxcoords(c2, WinkelTripel(T(7044801.6979576545), T(5231448.051548355)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon(T(0), T(0))
      c2 = convert(WinkelTripel, c1)
      @test isapproxcoords(c2, WinkelTripel(T(0), T(0)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Robinson" begin
      ...
      @test isapproxcoords(c2, Robinson(T(7620313.925950073), T(4805073.646653474)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Orthographic (Elliptical)" begin
      ...
      @test isapproxcoords(c2, OrthoNorth(T(4787610.688267582), T(-2764128.319646418)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, OrthoSouth(T(4787610.688267582), T(2764128.319646418)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, ShiftedOrthoElliptical(T(0), T(0)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Orthographic (Spherical)" begin
      ...
      @test isapproxcoords(c2, OrthoNorthSpherical(T(4783602.75), T(-2761814.335408735)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, OrthoSouthSpherical(T(4783602.75), T(2761814.335408735)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, ShiftedOrthoSpherical(T(0), T(0)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> TransverseMercator" begin
      ...
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(1548706.7916191491794), T(8451449.1987722350778)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(19.479895588178), T(75.662049225092))
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(9855841.2329353332058), T(6145496.1151551160577)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(5.458957393183), T(36.385237374895))
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(4328154.0835012728645), T(749647.6236903529367)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(61.965604972549), T(58.931370849824))
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(2727657.3379737519243), T(8283916.696409868168)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = LatLon(T(30), T(60))
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(3478021.0568801453), T(2237622.8976712096)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(35), T(65))
      c2 = convert(TM, c1)
      @test isapproxcoords(c2, TM(T(3736618.554412091), T(3043187.5889959945)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Albers" begin
      ...
      @test isapproxcoords(c2, AlbersUS(-T(7.231430540202629e6), T(1.1853758709623523e7)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NAD83}(-T(45), T(90))
      c2 = convert(AlbersUS, c1)
      @test isapproxcoords(c2, AlbersUS(-T(1.5156419949174397e7), T(1.3963188032694416e7)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NAD83}(T(45), -T(90))
      c2 = convert(AlbersUS, c1)
      @test isapproxcoords(c2, AlbersUS(T(472145.2567221438), T(2.4606302944375253e6)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon{NAD83}(-T(45), -T(90))
      c2 = convert(AlbersUS, c1)
      @test isapproxcoords(c2, AlbersUS(T(989573.4665648951), -T(5.723953827495912e6)))
      c3 = convert(LatLon{NAD83}, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Sinusoidal" begin
      ...
      @test isapproxcoords(c2, Sinusoidal(T(7.084329013634147e6), T(5.009377085697311e6)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> LambertAzimuthalEqualArea" begin
      ...
      c1 = LatLon(T(45), T(90))
      c2 = convert(LAEA, c1)
      @test isapproxcoords(c2, LAEA(T(5.879661317585923e6), T(5.643833348229035e6)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(-T(45), T(90))
      c2 = convert(LAEA, c1)
      @test isapproxcoords(c2, LAEA(T(7.066637230781689e6), -T(6.783200716618443e6)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, ShiftedLAEA(T(0), T(0)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> EqualEarth" begin
      ...
      @test isapproxcoords(c2, EqualEarth(T(7.396237374497802e6), T(5.466867760213717e6)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> UTM" begin
      ...
      @test isapproxcoords(c2, UTMNorth32(T(687071.439107327), T(6210141.326872105)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      @test isapproxcoords(c2, UTMSouth59(T(740526.3210524899), T(5123750.873037999)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> ShiftedCRS" begin
      ...
      @test isapproxcoords(c2, ShiftedMercator(T(8349161.809495518), T(5591495.9185533915)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(-T(45), T(90))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(T(8349161.809495518), -T(5591095.9185533915)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(T(45), -T(90))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(-T(11688346.533293724), T(5591495.9185533915)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = LatLon(-T(45), -T(90))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(-T(11688346.533293724), -T(5591095.9185533915)))
      c3 = convert(LatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "LatLon <> Projected (different datums)" begin
      ...
      @test isapproxcoords(c2, Mercator{ITRF{2008}}(T(10018754.171394622), T(5591295.9185533915)))

      c1 = Mercator{WGS84{1762}}(T(10018754.171394622), T(5591295.9185533915))
      c2 = convert(LatLon{ITRF{2008}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2008}}(T(45), T(90)))

      # ITRF2008 to ITRF2020
      ShiftedMercator = CoordRefSystems.shift(Mercator{ITRF{2020}}, lonₒ=15.0°, xₒ=200.0m, yₒ=200.0m)
      c1 = LatLon{ITRF{2008}}(T(45), T(90))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(T(8349161.8090374395), T(5591495.918071649)))
      ...
      c2 = convert(LatLon{ITRF{2020}}, c1)
      @test isapproxcoords(c2, LatLon{ITRF{2020}}(T(44.99999999574679), T(89.99999999177004)))

      # GGRS87 to WGS84
      c1 = LatLon{GGRS87}(T(45), T(90))
      c2 = convert(PlateCarree{WGS84{1762}}, c1)
      @test isapproxcoords(c2, PlateCarree{WGS84{1762}}(T(10019036.352134585), T(5009498.78549335)))

      c1 = PlateCarree{GGRS87}(T(10019036.352134585), T(5009498.78549335))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(45.002186400242984), T(90.00506975166428)))

      # NAD83 to WGS84
      c1 = LatLon{NAD83}(T(45), T(90))
      c2 = convert(WinkelTripel{WGS84{1762}}, c1)
      @test isapproxcoords(c2, WinkelTripel{WGS84{1762}}(T(7044801.698007298), T(5231448.051441181)))

      c1 = WinkelTripel{NAD83}(T(7044801.698007298), T(5231448.051441181))
      c2 = convert(LatLon{WGS84{1762}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{1762}}(T(45), T(90)))

      # WGS84 (G2296) to ETRF2020
      c1 = LatLon{WGS84{2296}}(T(45), T(90))
      c2 = convert(LambertAzimuthalEqualArea{52.0°,ETRF{2020}}, c1)
      @test isapproxcoords(c2, LambertAzimuthalEqualArea{52.0°,ETRF{2020}}(T(5122666.32147123), T(3145786.6707593063)))

      c1 = LambertAzimuthalEqualArea{52.0°,ETRF{2020}}(T(5122666.32147123), T(3145786.6707593063))
      c2 = convert(LatLon{WGS84{2296}}, c1)
      @test isapproxcoords(c2, LatLon{WGS84{2296}}(T(45), T(90)))
    ...
    @testset "GeocentricLatLon <> Projected" begin
      ...
      c2 = convert(Mercator, c1)
      @test isapproxcoords(c2, Mercator(T(10018754.171394622), T(5621538.488121794)))
      c3 = convert(GeocentricLatLon, c2)
      @test isapproxcoords(c3, c1)

      c1 = GeocentricLatLon(T(45), T(90))
      c2 = convert(WinkelTripel, c1)
      @test isapproxcoords(c2, WinkelTripel(T(7034650.123120441), T(5253308.640402036)))
      c3 = convert(GeocentricLatLon, c2)
      @test isapproxcoords(c3, c1)
      ...
      c1 = GeocentricLatLon(T(45), T(90))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(T(8349161.809495518), T(5621738.488121794)))
      c3 = convert(GeocentricLatLon, c2)
      @test isapproxcoords(c3, c1)
    ...
    @testset "Cartesian <> Projected" begin
      ...
      @test isapproxcoords(c2, Cartesian{WGS84Latest}(T(1), T(1)))
      ...
      @test isapproxcoords(c2, Mercator(T(1), T(2)))

      c1 = Cartesian(T(1), T(2))
      c2 = convert(OrthoNorth{WGS84Latest}, c1)
      @test isapproxcoords(c2, OrthoNorth(T(1), T(2)))

      c1 = Cartesian(T(1), T(2))
      c2 = convert(ShiftedMercator, c1)
      @test isapproxcoords(c2, ShiftedMercator(T(1), T(2)))
    ...
    @testset "Projected <> Projected" begin
      ...
      c2 = convert(WinkelTripel, c1)
      @test isapproxcoords(c2, WinkelTripel(T(7044801.69820402), T(5231448.051016482)))

      c1 = WinkelTripel(T(7044801.6979576545), T(5231448.051548355))
      c2 = convert(Robinson, c1)
      @test isapproxcoords(c2, Robinson(T(7620313.9259500755), T(4805073.646653474)))
      ...
      @test isapproxcoords(c2, WinkelTripel{ITRF{2020}}(T(7044801.699171027), T(5231448.049360464)))

      c1 = WinkelTripel{ITRF{2008}}(T(7044801.697957653), T(5231448.051548355))
      c2 = convert(Robinson{ITRF{2020}}, c1)
      @test isapproxcoords(c2, Robinson{ITRF{2020}}(T(7620313.811209339), T(4805075.1317550065)))
