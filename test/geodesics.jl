@testset "geodesics" begin
  ...
  @test isapprox(geodesicfwd(LatLon(0, 0), 90u"°", π * a / 2), LatLon(0, 90))
  ...
  if T === Float64
    ...
    c₁ = LatLon{GRS80S}(10, 20)
    c₂ = LatLon{GRS80S}(30, 50)
    Δ = deg2rad(50 - 20)
    greatcircle = atand(
